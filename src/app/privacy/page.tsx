    ...
    <main className="container max-w-3xl mx-auto py-12 px-4">
      <section className="privacy-policy">
        ...
        <p className="mb-4">
          ...
          of Service&quot;) carefully before using the Brat Generator web
          application (&quot;Service&quot;).
        </p>
        ...
        <p className="mb-4">
          ...
          by the terms and provisions of these Terms.
        </p>
        ...
        <p className="mb-4">
          You agree not to use the Service in any way that is harmful, illegal,
          or inappropriate. You are responsible for maintaining the
          confidentiality of your account and password.
        </p>

        <h2 className="text-2xl font-semibold mt-8 mb-2">4. Termination</h2>
        <p className="mb-4">
          We may terminate or suspend your account without notice for conduct
        ...
        <p className="mb-4">
          ...
          make available through the Service. Brat Generator has the right, but
          not the obligation, to monitor and review any content provided by its
          users. We may remove any content that, in our judgment, violates these
          Terms or may be harmful.
        </p>
        ...
        <p className="mb-4">
          Our Service may contain links to third-party websites. If you click on
          a third-party link, you will be directed to that site. We have no
          control over and assume no responsibility for the content or practices
        ...
        <p className="mb-4">
          In no event shall Brat Generator, nor its directors, employees,
